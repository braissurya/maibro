...
<body>
	...
	<div class="block" id="block-tables">	
		 <div class="secondary-navigation">
            <ul class="wat-cf">
              <li class="headerTitle" ><a href="#"> Master Cabang ${bankName}</a></li>             
            </ul>
          </div>
		 ...
		 <div class="content">
       	...
       	<table class="table">
				...
				<th>
					<c:choose>
                    	<c:when test="${sort eq 'id'}">
	                    	<c:choose>
				              	<c:when test="${sort_type eq 'asc' }"> <a href="javascript:gotoPage('${page}','id','desc','form')" class="up" >ID Cabang</a></c:when>
				              	<c:when test="${sort_type eq 'desc' }"><a href="javascript:gotoPage('${page}','id','asc','form')" class="down" >ID Cabang</a></c:when>
				              	<c:otherwise><a href="javascript:gotoPage('${page}','id','asc','form')"  >ID Cabang</a></c:otherwise>
			              	</c:choose>
			            </c:when>
		              	<c:otherwise>
		              		<a href="javascript:gotoPage('${page}','id','asc','form')"  >ID Cabang</a>
		              	</c:otherwise>
	              	</c:choose>
				</th>
				<th>
					<c:choose>
                    	<c:when test="${sort eq 'namaBank'}">
	                    	<c:choose>
				              	...
				              	<c:when test="${sort_type eq 'desc' }"><a href="javascript:gotoPage('${page}','namaBank','asc','form')" class="down" >Nama Perusahaan</a></c:when>
				...
				<th>
					<c:choose>
                    	<c:when test="${sort eq 'jenis'}">
	                    	<c:choose>
				              	<c:when test="${sort_type eq 'asc' }"> <a href="javascript:gotoPage('${page}','jenis','desc','form')" class="up" >Jenis</a></c:when>
				              	<c:when test="${sort_type eq 'desc' }"><a href="javascript:gotoPage('${page}','jenis','asc','form')" class="down" >Jenis</a></c:when>
				              	<c:otherwise><a href="javascript:gotoPage('${page}','jenis','asc','form')"  >Jenis</a></c:otherwise>
			              	</c:choose>
			            </c:when>
		              	<c:otherwise>
		              		<a href="javascript:gotoPage('${page}','jenis','asc','form')"  >Jenis</a>
		              	</c:otherwise>
	              	</c:choose>
				</th>
				<th>
					<c:choose>
                    	<c:when test="${sort eq 'cab_induk_id'}">
	                    	<c:choose>
				              	<c:when test="${sort_type eq 'asc' }"> <a href="javascript:gotoPage('${page}','cab_induk_id','desc','form')" class="up" >Cabang Induk</a></c:when>
				              	<c:when test="${sort_type eq 'desc' }"><a href="javascript:gotoPage('${page}','cab_induk_id','asc','form')" class="down" >Cabang Induk</a></c:when>
				              	<c:otherwise><a href="javascript:gotoPage('${page}','cab_induk_id','asc','form')"  >Cabang Induk</a></c:otherwise>
			              	</c:choose>
			            </c:when>
		              	<c:otherwise>
		              		<a href="javascript:gotoPage('${page}','cab_induk_id','asc','form')"  >Cabang Induk</a>
		              	</c:otherwise>
	              	</c:choose>
				</th>
				<th>
					<c:choose>
                    	<c:when test="${sort eq 'kode_bank'}">
	                    	<c:choose>
				              	<c:when test="${sort_type eq 'asc' }"> <a href="javascript:gotoPage('${page}','kode_bank','desc','form')" class="up" >Kode Bank</a></c:when>
				              	<c:when test="${sort_type eq 'desc' }"><a href="javascript:gotoPage('${page}','kode_bank','asc','form')" class="down" >Kode Bank</a></c:when>
				              	<c:otherwise><a href="javascript:gotoPage('${page}','kode_bank','asc','form')"  >Kode Bank</a></c:otherwise>
			              	</c:choose>
			            </c:when>
		              	<c:otherwise>
		              		<a href="javascript:gotoPage('${page}','kode_bank','asc','form')"  >Kode Bank</a>
		              	</c:otherwise>
	              	</c:choose>
				</th>
				<th>
					<c:choose>
                    	<c:when test="${sort eq 'nama'}">
	                    	<c:choose>
				              	<c:when test="${sort_type eq 'asc' }"> <a href="javascript:gotoPage('${page}','nama','desc','form')" class="up" >Nama Cabang</a></c:when>
				              	<c:when test="${sort_type eq 'desc' }"><a href="javascript:gotoPage('${page}','nama','asc','form')" class="down" >Nama Cabang</a></c:when>
				              	<c:otherwise><a href="javascript:gotoPage('${page}','nama','asc','form')"  >Nama Cabang</a></c:otherwise>
			              	</c:choose>
			            </c:when>
		              	<c:otherwise>
		              		<a href="javascript:gotoPage('${page}','nama','asc','form')"  >Nama Cabang</a>
		              	</c:otherwise>
	              	</c:choose>
				</th>
				<th>
			...
			<c:forEach items="${listMstCabBank}" var="p">
			<tr <c:choose><c:when test="${(s.count % 2) eq 0}">class="odd"</c:when><c:otherwise>class="even"</c:otherwise></c:choose>>
				...
				<td class="last">
						<a href="${path}/master/cabbank/edit/${p.id}/${bank}" title="edit">
	                      <img src="${path }/static/pilu/images/icons/application_edit.png" alt="Edit" />
	                    </a>
	                    <a href="${path}/master/cabbank/view/${p.id}/${bank}" title="view">
	                      <img src="${path }/static/pilu/images/icons/view.png" alt="View" />
	                    </a>
	                    <a href="javascript:if(confirm('Are you sure want to Delete \'Id : ${p.id}, Nama Bank : ${bankName}\' ?'))window.location='${path}/master/cabbank/delete/${p.id}/${bank}';" title="delete">
                ...
                <div class="actions-bar wat-cf">
                  <div class="actions">
                    ...
                    <button class="button" type="button" onclick="window.location='${path}/master/cabbank/new/${bank}';">
