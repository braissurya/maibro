...
<body>
	...
	<div class="block" id="block-tables">	
		 <div class="secondary-navigation">
            <ul class="wat-cf">
              <li class="headerTitle" ><a href="#"> Master Perusahaan</a></li>             
            </ul>
          </div>
		 ...
		 <div class="content">
       	...
       	<table class="table">
			<tr>
				...
				<th>
					<c:choose>
                    	<c:when test="${sort eq 'id'}">
	                    	<c:choose>
				              	<c:when test="${sort_type eq 'asc' }"> <a href="javascript:gotoPage('${page}','id','desc','form')" class="up" >ID</a></c:when>
				              	<c:when test="${sort_type eq 'desc' }"><a href="javascript:gotoPage('${page}','id','asc','form')" class="down" >ID</a></c:when>
				              	<c:otherwise><a href="javascript:gotoPage('${page}','id','asc','form')"  >ID</a></c:otherwise>
			              	</c:choose>
			            </c:when>
		              	<c:otherwise>
		              		<a href="javascript:gotoPage('${page}','id','asc','form')"  >ID</a>
		              	</c:otherwise>
	              	</c:choose>
				</th>
				<th>
				...
				<th>
					<c:choose>
                    	<c:when test="${sort eq 'nama'}">
	                    	<c:choose>
				              	<c:when test="${sort_type eq 'asc' }"> <a href="javascript:gotoPage('${page}','nama','desc','form')" class="up" >Nama Bank</a></c:when>
				              	<c:when test="${sort_type eq 'desc' }"><a href="javascript:gotoPage('${page}','nama','asc','form')" class="down" >Nama Bank</a></c:when>
				              	<c:otherwise><a href="javascript:gotoPage('${page}','nama','asc','form')"  >Nama Bank</a></c:otherwise>
			              	</c:choose>
			            </c:when>
		              	<c:otherwise>
		              		<a href="javascript:gotoPage('${page}','nama','asc','form')"  >Nama Bank</a>
		              	</c:otherwise>
	              	</c:choose>
				</th>
				<th>
				...
				<th>
					<c:choose>
                    	<c:when test="${sort eq 'polis_induk'}">
	                    	<c:choose>
				              	<c:when test="${sort_type eq 'asc' }"> <a href="javascript:gotoPage('${page}','polis_induk','desc','form')" class="up" >Polis Induk</a></c:when>
				              	<c:when test="${sort_type eq 'desc' }"><a href="javascript:gotoPage('${page}','polis_induk','asc','form')" class="down" >Polis Induk</a></c:when>
				              	<c:otherwise><a href="javascript:gotoPage('${page}','polis_induk','asc','form')"  >Polis Induk</a></c:otherwise>
			              	</c:choose>
			            </c:when>
		              	<c:otherwise>
		              		<a href="javascript:gotoPage('${page}','polis_induk','asc','form')"  >Polis Induk</a>
		              	</c:otherwise>
	              	</c:choose>
				</th>
				<th>
			...
			<c:forEach items="${listMstBank}" var="p">
			<tr <c:choose><c:when test="${(s.count % 2) eq 0}">class="odd"</c:when><c:otherwise>class="even"</c:otherwise></c:choose>>
				...
				<td>${p.nama}</td>
				<td>
					<img alt="logo perusahaan" src="${path }/imagegenerator/inline/logo/${p.id}.gif"  width="70px">
				</td>
				<td>
					<img alt="logo perusahaan" src="${path }/imagegenerator/inline/logo/${p.id}_ttd.gif"  width="50px">
				</td>
				<td>
					<img alt="logo perusahaan" src="${path }/imagegenerator/inline/logo/${p.id}_cap.gif"  width="50px">
				</td>
				<td>${p.polis_induk}</td>
				<td>${p.createuser}</td>
				...
				<td class="last">
						<a href="${path}/master/cabbank/${p.id}" title="cabang bank">
	                      <img src="${path }/static/pilu/images/icons/branch.png" alt="cabang bank" />
	                    </a>
						<a href="${path}/master/bank/edit/${p.id}" title="edit">
	                      <img src="${path }/static/pilu/images/icons/application_edit.png" alt="Edit" />
	                    </a>
	                    <a href="${path}/master/bank/view/${p.id}" title="view">
	                      <img src="${path }/static/pilu/images/icons/view.png" alt="View" />
	                    </a>
	                    <a href="javascript:if(confirm('Are you sure want to Delete \'Id : ${p.id}\' ?'))window.location='${path}/master/bank/delete/${p.id}';" title="delete">
                ...
                <div class="actions-bar wat-cf">
                  <div class="actions">
                    <button class="button" type="button" onclick="window.location='${path}/master/bank/new';">
