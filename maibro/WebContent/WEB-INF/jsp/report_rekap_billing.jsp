	...
	<div id="main" class="fullwidth">
		<div class="block" id="block-forms">
			<div class="secondary-navigation">
				<ul class="wat-cf">
					<li class="headerTitle"><a href="#"> Laporan Rekapitulasi Billing</a>
					</li>
				</ul>
			</div>
						...
						<div class="columns wat-cf">
							<table class="report">
								...
								<tr>
									...
									<td>
										<input type="radio" name="status" value="" checked="checked"><label>All</label>
										<input type="radio" name="status" value="1"><label>Paid</label>
										<input type="radio" name="status" value="2"><label>Lebih Bayar</label>
										<input type="radio" name="status" value="3"><label>Kurang Bayar</label>
										<input type="radio" name="status" value="0"><label>Outstanding</label>
									</td>
								</tr>
								<tr>
